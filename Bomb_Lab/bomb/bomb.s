...
0000000000400da0 <main>:
  ...
  400ea7:	48 89 c7             	mov    %rax,%rdi // %rdi stores the input value
...
0000000000400efc <phase_2>:
  ...
  400f02:	48 89 e6             	mov    %rsp,%rsi // newly allocated space on stack is passed as second parameter
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)
  400f0e:	74 20                	je     400f30 <phase_2+0x34> //no.1
...
0000000000400f43 <phase_3>:
  ...
  400f60:	83 f8 01             	cmp    $0x1,%eax // %eax should be greater than 0x1
...
0000000000400fce <func4>: // (first-entered number(rdi/edi), 0(esi), 14(edx), second entered-number(rcx/ecx))
  400fce:	48 83 ec 08          	sub    $0x8,%rsp
  400fd2:	89 d0                	mov    %edx,%eax // %eax = 14
  400fd4:	29 f0                	sub    %esi,%eax // %eax = %eax - 0 = 14
  400fd6:	89 c1                	mov    %eax,%ecx // %ecx = 14
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx // %ecx >>(logical) 31 = 0
  400fdb:	01 c8                	add    %ecx,%eax // eax = 0 + eax = eax = 14
  400fdd:	d1 f8                	sar    %eax // no parameter provided, implies a shift of 1
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx // ecx = 7
  400fe2:	39 f9                	cmp    %edi,%ecx
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> // first entered number <= 7?
...
000000000040100c <phase_4>:
  ...
  401029:	83 f8 02             	cmp    $0x2,%eax // $eax should equal to 0x2
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp) // first should be <= than 0xe (14)
  401033:	76 05                	jbe    40103a <phase_4+0x2e>
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx // third argument is 14
  40103f:	be 00 00 00 00       	mov    $0x0,%esi // second argument to <func4> is 0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi // first argument to <func4> is our first entered number:
  401048:	e8 81 ff ff ff       	callq  400fce <func4>
  40104d:	85 c0                	test   %eax,%eax // the returned value from func4 has to be zero
  40104f:	75 07                	jne    401058 <phase_4+0x4c>
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp) // the resultant 0xc(%rsp) should be zero as well.
...
0000000000401062 <phase_5>:
  ...
  401067:	48 89 fb             	mov    %rdi,%rbx // input store in rbx
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
  401078:	31 c0                	xor    %eax,%eax
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length> 
  40107f:	83 f8 06             	cmp    $0x6,%eax  // assume this means string length of 6?
  401082:	74 4e                	je     4010d2 <phase_5+0x70> // no.1
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx // no.3 %ecx = %rbx + %rax, access entered string in hex one byte at a time, and store it at ecx
  40108f:	88 0c 24             	mov    %cl,(%rsp) 
  401092:	48 8b 14 24          	mov    (%rsp),%rdx // lower 1 byte of ecx stored to %rdx (one byte at a time) 
  401096:	83 e2 0f             	and    $0xf,%edx // mask: 0x00001111 and with lower 1 byte, get lower 4 bits
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx // bunch of random characters at 0x4024b0: m(0)a(1)d(2)u(3)i(4)e(5)r(6)s(7)n(8)f(9)o(A)t(B)v(C)b(D)y(E)l(F) , the lower 4 bits acts as index
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)
  4010a4:	48 83 c0 01          	add    $0x1,%rax
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29> // no.4 if not equal, always go back to no.3
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi // string at 0x40245e is "flyers", so our entered value(acts as index), need to get "flyers" from the random string at 0x4024b0, index so should be 9FE567 -> ionefg / IONEFG 
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal>
  4010c2:	85 c0                	test   %eax,%eax // eax needs to be 0, means that strings are equal?
  4010c4:	74 13                	je     4010d9 <phase_5+0x77> // no.5
  4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb>
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax // no.2 %eax = 0
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax // no.6
...
00000000004010f4 <phase_6>: // rdi and rax holds the input value
  4010f4:	41 56                	push   %r14
  4010f6:	41 55                	push   %r13
  4010f8:	41 54                	push   %r12
  4010fa:	55                   	push   %rbp
  4010fb:	53                   	push   %rbx
  4010fc:	48 83 ec 50          	sub    $0x50,%rsp // 80/4 = 20 blocks
  401100:	49 89 e5             	mov    %rsp,%r13 // r13 = rsp
  401103:	48 89 e6             	mov    %rsp,%rsi
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>
  40110b:	49 89 e6             	mov    %rsp,%r14 // r14 = rsp
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d // r12 = 0
  401114:	4c 89 ed             	mov    %r13,%rbp // rbp = r13 = %rsp + n // no.6
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax // eax = (%rsp+n)
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax // (%rsp+n)-1  needs to <= 0x5  , namely any value entered <= 0x5 + 0x1 = 0x6
  401121:	76 05                	jbe    401128 <phase_6+0x34> // no.1
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d // no.2 r12d = 0+1 = 1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f> // no 2
  401132:	44 89 e3             	mov    %r12d,%ebx
  401135:	48 63 c3             	movslq %ebx,%rax // rax = ebx = r12d //no.5
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax // eax = (%rsp+4*rax) 
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp) // (%rsp+4*%rax) should != (%rsp) , goes through loop, checking if any value equals another, all elements should not equal to each other
  40113e:	75 05                	jne    401145 <phase_6+0x51>
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx // ebx +=1
  401148:	83 fb 05             	cmp    $0x5,%ebx
  40114b:	7e e8                	jle    401135 <phase_6+0x41> // no.4
  40114d:	49 83 c5 04          	add    $0x4,%r13 // r13 = %rsp + 4 
  401151:	eb c1                	jmp    401114 <phase_6+0x20> // no.5
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi // %rsi = (%rsp+0x18)
  401158:	4c 89 f0             	mov    %r14,%rax // rax = r14 = %rsp
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx // ecx(rcx) = 0x7
  401160:	89 ca                	mov    %ecx,%edx
  401162:	2b 10                	sub    (%rax),%edx // %edx = %ecx(7) - (%rsp+n)
  401164:	89 10                	mov    %edx,(%rax) // (%rsp+n) = %ecx - (%rsp+n)old // every value now becomes 7-original_value
  401166:	48 83 c0 04          	add    $0x4,%rax
  40116a:	48 39 f0             	cmp    %rsi,%rax
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>
  40116f:	be 00 00 00 00       	mov    $0x0,%esi // esi(rsi) = 0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx // eax = 0x1, edx = 0x6032d0
  40117a:	83 c0 01             	add    $0x1,%eax
  40117d:	39 c8                	cmp    %ecx,%eax
  40117f:	75 f5                	jne    401176 <phase_6+0x82>
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx  ////    // the numbers string we entered now is: (7-value1) (7-value2) (7-value3) (7-value4) (7-value5) (7-value6)
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) // 0x6032d0 + 0x8*(7-value) stored to %rsp + 20/28/.../0x48 = %rdx = 0x6032d0 Start of a new block
  40118d:	48 83 c6 04          	add    $0x4,%rsi
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7>
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx // %ecx = (%rsp + %rsi) where %rsi is 4n (n=0 1 2 3) 
  40119a:	83 f9 01             	cmp    $0x1,%ecx
  40119d:	7e e4                	jle    401183 <phase_6+0x8f> // if %ecx <= 1 go to 401183
  ...
  4011ba:	48 89 d9             	mov    %rbx,%rcx // %rcx = address stored at %rsp + 0x20
  4011bd:	48 8b 10             	mov    (%rax),%rdx // %rdx = address stored at %rsp + 0x28
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx) // values stored at %rcx + 0x8, which is pointer to another item, let it equal to the %rdx value (an address)
  ...
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax // 0x20(%rsp) is the initial value of %rbx
  4011e3:	8b 00                	mov    (%rax),%eax
  4011e5:	39 03                	cmp    %eax,(%rbx) // %rax stores (%rbx+0x8), this value is a pointer to other node, (%rax) extracts the value of other node, compare it with the current node value (%rbx), (%rbx) needs to be greater than (%rax), value of current node needs to be >= the value of the node it points to
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx
  4011f2:	83 ed 01             	sub    $0x1,%ebp // ebp from 5-1, because we have 6 numbers, so 5 comparisons
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb> // value 1,2,3,4,5,6 access node 6,5,4,3,2,1      we need node sequence as node 3,4,5,6,1,2  so the value entered should be 4,3,2,1,6,5
...
0000000000401204 <fun7>:
  ...
  40120d:	8b 17                	mov    (%rdi),%edx // edx = 36 ($ char)
  40120f:	39 f2                	cmp    %esi,%edx // esi is the value you entered, edx = 0x24 -> 0x08 -> 0x06 -> 0x01
  401211:	7e 0d                	jle    401220 <fun7+0x1c> // if entered value >= $edx, return with value of 0
  401213:	48 8b 7f 08          	mov    0x8(%rdi),%rdi
  401217:	e8 e8 ff ff ff       	callq  401204 <fun7>
  40121c:	01 c0                	add    %eax,%eax
  40121e:	eb 1d                	jmp    40123d <fun7+0x39>
  401220:	b8 00 00 00 00       	mov    $0x0,%eax
  401225:	39 f2                	cmp    %esi,%edx // e.g esi = 7, edx = 6
...
0000000000401242 <secret_phase>:
  ...
  401248:	ba 0a 00 00 00       	mov    $0xa,%edx // edx=10 strtol(line_entered, 0, 10)
  40124d:	be 00 00 00 00       	mov    $0x0,%esi // esi=0
  401252:	48 89 c7             	mov    %rax,%rdi // rdi= the line you've entered
  401255:	e8 76 f9 ff ff       	callq  400bd0 <strtol@plt>
  40125a:	48 89 c3             	mov    %rax,%rbx // the number in your string gets returned
  40125d:	8d 40 ff             	lea    -0x1(%rax),%eax
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax // entered number should <= 0x3e8+1 = 1001
  401265:	76 05                	jbe    40126c <secret_phase+0x2a>
  401267:	e8 ce 01 00 00       	callq  40143a <explode_bomb>
  40126c:	89 de                	mov    %ebx,%esi // fun7 second argument: value you entered
  40126e:	bf f0 30 60 00       	mov    $0x6030f0,%edi // fun7 first argument: value 0x24
  401273:	e8 8c ff ff ff       	callq  401204 <fun7>
  401278:	83 f8 02             	cmp    $0x2,%eax // func7 returned value should be 2
...
00000000004015c4 <phase_defused>:
  ...
  4015d8:	83 3d 81 21 20 00 06 	cmpl   $0x6,0x202181(%rip)        # 603760 <num_input_strings> $rip=0x4015df + 0x202181 = 0x603760, value at this position is the phase no.
  4015df:	75 5e                	jne    40163f <phase_defused+0x7b>
  4015e1:	4c 8d 44 24 10       	lea    0x10(%rsp),%r8
  4015e6:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx
  4015eb:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx
  4015f0:	be 19 26 40 00       	mov    $0x402619,%esi // %d %d %s
  4015f5:	bf 70 38 60 00       	mov    $0x603870,%edi // "" needs to be "value value DrEvil" 
  4015fa:	e8 f1 f5 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  4015ff:	83 f8 03             	cmp    $0x3,%eax ///
  401602:	75 31                	jne    401635 <phase_defused+0x71>
  401604:	be 22 26 40 00       	mov    $0x402622,%esi // DrEvil
  401609:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi // address for the string entered
  ...
  401630:	e8 0d fc ff ff       	callq  401242 <secret_phase> // entrance to secret phase 
